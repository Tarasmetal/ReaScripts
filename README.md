...
| **Action List and toolbars Command ID Fixer** | Конвертирует технические ID скриптов в читаемые имена на основе их описания в `reaper-kb.ini` и меню. | [📖 Инструкция](DOC/trs_Action%20List%20and%20toolbars%20Command%20ID%20Fixer.md) |
