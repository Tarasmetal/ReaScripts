...
--]]
  ...
  script_title = "trs_Save all tracks FX chains to project path"
  ...
  if count_sel_track ~= 0 then
    ret = reaper.MB('Cохранить FX для выбраных треков'..'\n'..
           saving_path..' ?', 'Сохранить все треки FX', 1)
  else
    ret = reaper.MB('Cохранить все свои FX в'..'\n'..
             saving_path..' ?', 'Сохранить все треки FX', 1)
  end
